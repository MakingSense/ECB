...
if( !function_exists( 'otw_ibsw_init' ) ){
	...
	function otw_ibsw_init(){
		...
		global $otw_ibsw_plugin_url, $otw_ibsw_plugin_options, $otw_ibsw_shortcode_component, $otw_ibsw_shortcode_object, $otw_ibsw_form_component, $otw_ibsw_validator_component, $otw_ibsw_form_object, $wp_ibsw_cs_items, $otw_ibsw_js_version, $otw_ibsw_css_version, $wp_widget_factory;
		...
		$otw_ibsw_shortcode_object->shortcodes['info_box'] = array( 'title' => __('Info Box', 'otw_ibsw'),'enabled' => true,'children' => false, 'parent' => false, 'order' => 2,'path' => dirname( __FILE__ ).'/otw_components/otw_shortcode/', 'url' => $otw_ibsw_plugin_url.'/include/otw_components/otw_shortcode/', 'dialog_text' => $otw_ibsw_dialog_text  );
...
if( !function_exists( 'otw_ibsw_init_admin_menu' ) ){
	...
	function otw_ibsw_init_admin_menu(){
		...
		add_menu_page(__('Info Boxes Shortcode And Widget', 'otw_ibsw'), __('Info Boxes Shortcode And Widget', 'otw_ibsw'), 'manage_options', 'otw-ibsw-settings', 'otw_ibsw_settings', $otw_ibsw_plugin_url.'/images/otw-sbm-icon.png');
		add_submenu_page( 'otw-ibsw-settings', __('Settings', 'otw_ibsw'), __('Settings', 'otw_ibsw'), 'manage_options', 'otw-ibsw-settings', 'otw_ibsw_settings' );
